...
public class Challenge_4 {
    public static void printMegaBytesAndKiloBytes(int kiloBytes) {
        double mbRatetoKB = 1024;
        if(kiloBytes <= 0){
            System.out.println("Invalid Value");
        }else{
            System.out.println(kiloBytes + " KB = " + ((int)(kiloBytes/mbRatetoKB)) + " MB and " + ((int)(kiloBytes%mbRatetoKB)) + " KB");
           //System.out.println(kiloBytes%mbRatetoKB);
        }
